...
{
  RECT rc;
  /* Full screen output flag */
  static BOOL IsFullScreen = FALSE;
  /* Stored window original size and position */
  static RECT SaveRC;
  ...
  GetClientRect(VG4_Anim.hWnd, &rc);
  PostMessage(VG4_Anim.hWnd, WM_SIZE, 0,

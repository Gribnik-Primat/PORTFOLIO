...
BOOL IB1_GeomLoad( IB1GOBJ *Go, CHAR *FileName )
{
  ...
  IB1_PrimDefaultColor = VecSet(1, 1, 1);
  for (p = 0; p < pn; p++)
  {
    INT
    ...
    IB1_PrimCreate(&prim, IB1_PRIM_TRIMESH, vn, fn * 3, NULL, NULL);
    /* копируем вершины */
    ...
    IB1_GeomAddPrim(Go, &prim);
  }

  free(ReadV);
  return TRUE;
} /* End of 'IB1_GeomLoad' function */
